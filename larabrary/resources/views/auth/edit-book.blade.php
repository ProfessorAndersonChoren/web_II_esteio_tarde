...
@section('main-content')
    ...
    <form action="#" method="post" class="flex flex-col w-full">
        ...
        <input type="text" id="title" name="title" class="mb-6 custom-input" value="{{$book['title']}}"
            required>
        <label for="author" class="custom-label">Autor do livro:</label>
        <input type="text" id="author" name="author" class="mb-6 custom-input" value="{{$book['author']}}"
            required>
